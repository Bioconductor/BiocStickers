...
col_border_low <- "#000000"
col_border <- "#2e3131"
col_bg <- "#89c4f4"                     # Jordy Blue
img <- readPNG("./Bioc2023-drawing.png")
img <- rasterGrob(img, width = 1.46, x = 0.5, y = 0.5,
                  interpolate = TRUE)
hex <- ggplot() +
    geom_hexagon(size = 1.2, fill = col_bg, color = NA) +  # full
    geom_subview(subview = img, x = 1.02, y = 0.9,
    ...
    geom_url(url = "BioC2023", x = 0.97, y = 1.85,
             family = "Aller", size = 16, color = col_text,
             angle = -30) + 
    geom_url(url = "www.bioconductor.org", size = 6, color = "#000000",
             x = 0.31, y = 0.52, angle = -30) +
    theme_sticker()
save_sticker("BioC2023.png", hex, dpi = 300)
...
hex <- ggplot() +
    ...
    geom_url(url = "www.bioconductor.org", size = 6, color = "#000000",
             x = 0.31, y = 0.52, angle = -30) +
    theme_sticker()
save_sticker("BioC2023-a.png", hex, dpi = 300)
...
hex <- ggplot() +
    ...
    geom_url(url = "www.bioconductor.org", size = 6, color = "#000000",
             x = 0.31, y = 0.52, angle = -30) +
    theme_sticker()
save_sticker("BioC2023-b.png", hex, dpi = 300)
